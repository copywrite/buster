...
Usage:
  ...
  buster.py --version
  Notes:
    1. generate function did not drop the static file path which contains version parameter, fixed it 
        ...
        for root, dirs, filenames in os.walk(static_path):
            for filename in filenames:
                ...
                if file_regex.match(filename):
                    ...
                    print '// Drop queryString in filename'
                    print 'from: ', filename
                    newname = urlparse(filename).path
                    print 'to: ', newname
